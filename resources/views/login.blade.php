            ...
            <div class="leading-loose">
                @if (session()->has('mssg'))
                    <div class="bg-green-300 mb-2 border border-green-300 text-green-600 px-4 py-3 rounded relative"
                        ...
                        <span class="block sm:inline">Your Registration is Succesfully completed. Please Login!!</span>
                ...
                @if (session()->has('msgg'))
                    <div class="bg-green-300 mb-2 border border-green-300 text-green-600 px-4 py-3 rounded relative"
                        ...
                        <span class="block sm:inline">Your Registration is successfully completed. Please login!!</span>
                        <span class="absolute top-0 bottom-0 right-0 px-4 py-3">
                ...
                @endif
                @if (session()->has('msgg1'))
                <div class="bg-green-300 mb-2 border border-green-300 text-green-600 px-4 py-3 rounded relative"
                    role="alert">

                    <span class="block sm:inline">Your password changed successfully!!</span>
                    <span class="absolute top-0 bottom-0 right-0 px-4 py-3">
                        <svg class="fill-current h-6 w-6 text-green" role="button"
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                            <title>Close</title>
