    ...
    @foreach ($data as $key)
        ...
        @if (session()->has('message'))
            <div class="bg-green-300 mb-2 border border-green-300 text-green-600 px-4 py-3 rounded relative" role="alert">
                ...
                <span class="block sm:inline">Your Organ Request is successfully completed.</span>
        ...
        <div class="flex flex-1  flex-col md:flex-row lg:flex-row mx-2">
            <div class="mb-2 border-solid border-gray-300 rounded border shadow-sm w-full">
                ...
                <div class="flex flex-1 px-3 py-3 h-14 bg-red-500 ">
                ...
                <div class="p-3">
                    <form action="{{ url('ReqOrgan') }}" method="POST" class="w-full">
                        @csrf
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6">
                            ...
                            <div class="w-full px-3">
                                <label for="grid-password">
                                    Have you ever had an organ transplant before?
                                </label>
                                <select name="transplant_before" required=""
                                    class="appearance-none block w-full bg-grey-200 text-grey-darker border border-grey-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-grey">
                                    <option value="" disabled selected>Choose </option>
